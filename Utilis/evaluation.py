...
**Description**
This file contains a utilis function 'perform_evaluation' that calculates various forcasting metrics.

**Arguments**
df : pandas dataframe of multivariate timeseries dataset

forecasts_df : pandas dataframe of forecasts
