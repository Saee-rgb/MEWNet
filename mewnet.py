...
This file contains function `mewnet` that combines wavelet decomposition with multilayer perceprton based model `bredvarnet`.

**Arguments**

df :  pandas dataframe of multivariate timeseries

istest : (True/False) Whether test data is available separately or not

exo : List of exogenous variables , set to None if not

exo_test : Test dataset of exogenus variables

diff : (True/False) Flag to difference the data

std : (True/False) Flag to standardise the data

wname : name of wavelet used (all options as in MODWT)

lev : number of decompositions
...
A pandas dataframe of forecasted values of horizon length of target variables
"""
...
def mewnet(df ,
 ...
 ##Fit BRedVARNet and forecast!
  ...
  for dframe in newseparate_dfs:
    ...
    forecasts_df = BRedVARNet(dframe, exo_test = exo_test ,standardise=std, num_epochs = num_epochs , batch_size = batch_size,
